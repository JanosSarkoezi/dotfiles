...
domain_props = {
    ["all"] = {
        ...
        user_stylesheet_uri     = "file://" .. luakit.data_dir .. "/all-dark.css",
    },
    ["google.de"] = {
        enable_scripts          = true,
        enable_plugins          = true,
    ...
    ["github.com"] = {
        enable_scripts = true,
        enable_plugins = true,
        user_stylesheet_uri     = "file://" .. luakit.data_dir .. "/github-dark.css",
    },
    ["stackoverflow.com"] = {
        enable_scripts = true,
        enable_plugins = true,
        user_stylesheet_uri     = "file://" .. luakit.data_dir .. "/stackoverflow-dark.css",
    },
    ["youtube.com"] = {
        enable_scripts = true,
        enable_plugins = true,
